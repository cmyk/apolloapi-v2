...
module.exports.auth = {
  ...
  async switchBitcoinSoftware(targetSoftware) {
    ...
    try {
      ...
      if (!['core-25.1', 'core-28.1', 'core-29.2', 'knots-29.2', 'knots-bip110'].includes(targetSoftware)) {
        throw new Error(`Invalid software: ${targetSoftware}. Valid options: core-25.1, core-28.1, core-29.2, knots-29.2, knots-bip110`);
      }
